...
train = pd.read_csv(os.path.join('C:\\Users\Matt\Documents\Projects\Kaggle\kaggle-temp\data', 'train.csv'))
test = pd.read_csv(os.path.join('C:\\Users\Matt\Documents\Projects\Kaggle\kaggle-temp\data\test', 'test.csv'))
